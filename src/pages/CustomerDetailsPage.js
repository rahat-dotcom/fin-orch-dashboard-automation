...
class CustomerDetailsPage extends BasePage {
  constructor(page) {
    ...
    // Header elements
    this.backBtn = page.locator('button[aria-label="Back"], a[aria-label="Back"]').first();
    ...
    this.transactionsTab = page.getByRole('tab', { name: 'Transactions' }).or(page.locator('button:has-text("Transactions")'));
    ...
    // Customer info card
    this.customerInfoCard = page.locator('section:has-text("Customer information")');
